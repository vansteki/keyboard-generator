...
/***/ function(module, exports, __webpack_require__) {
	...
	$("#bulb").click(function () {
	  _client2.default.emit("incr_percent");
	});
	...
	$(window).keyup(function (e) {
	  switch (e.which) {
	    case 37:
	      ...
	      break;
	    case 39:
	      hold && _client2.default.emit("incr_percent");
	      hold = false;
	      break;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _share = __webpack_require__(2);
	...
	var socket = _socket2.default.connect("http://" + _share.hostname, {
	...
	socket.on("disconnect", function () {
	  ...
	  (0, _share.maintaining)();
	});

	socket.on("sync_visitor", function (data) {
	  (0, _share.syncVisitor)(data.visitor);
	});

	socket.on("sync_percent", function (data) {
	  (0, _share.syncBulb)(data.per);
	});

	socket.on("congraz", function () {
	  (0, _share.displayResult)();
	});
...
/***/ function(module, exports) {
	...
	var hostname = exports.hostname = location.hostname + ":8000";

	var maintaining = exports.maintaining = function maintaining() {
	  $("#people").text("發電機維護中");
	};

	var syncVisitor = exports.syncVisitor = function syncVisitor(visitor) {
	  $("#people").text("目前有" + visitor + "個人在愛地球");
	};

	var syncBulb = exports.syncBulb = function syncBulb(per) {
	  $("#per").text(per + "%");
	  $("#mask").css("height", 2.8 * per + "px");
	};

	var displayResult = exports.displayResult = function displayResult() {
	  $("#prize").show();
	  $("#sound").get(0).play();
	};
